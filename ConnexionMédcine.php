          ...
          <div class="card card-registration my-4">
            <div class="row g-0">
              <div class="col-xl-6 d-none d-xl-block">
                <img src="./img/DotorPic2Test.jpg" alt="Sample photo" class="img-fluid" style="border-top-left-radius: .25rem; border-bottom-left-radius: .25rem; " />
              </div>
              <div class="col-xl-6">
                <div class="card-body p-md-5 text-black mt-5">
                  ...
                  <h4 class="mb-5 text-center">Accédez à votre compte et découvrez de nouvelles opportunités professionnelles <br> Connectez-vous dès maintenant !</h4>
